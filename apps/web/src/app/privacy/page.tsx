        ...
        <div className="max-w-3xl">
          <Prose>
            ...
            <ul>
              ...
              <li><strong>Automatically</strong> - limited technical data when you visit our website, agent portal, or admin application, as described under &ldquo;Website analytics&rdquo; below and in our <a href="/legal/cookies">Cookie Policy</a>.</li>
            </ul>

            <h2>Website analytics</h2>
            <p>To understand how our sites are used and to keep them secure, we record a basic event for each page view across our public website, agent portal, and admin application. Each event includes the page path visited (without any query string), the date and time, your browser type (user-agent), the page that referred you, and an <strong>approximate country</strong> derived from your IP address by our content delivery network. We do <strong>not</strong> store your raw IP address; instead we keep a one-way, irreversible salted hash of it, used only to estimate the number of unique visitors. This analytics is <strong>first-party and cookieless</strong> - it sets no cookies, uses no third-party trackers or advertising networks, and does not attempt to identify you personally. Country is only as accurate as the network-level lookup allows and may be unavailable.</p>
