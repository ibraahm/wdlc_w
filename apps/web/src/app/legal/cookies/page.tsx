            ...
            <div className="max-w-3xl">
              <Prose>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Security / anti-fraud</strong> - our public forms use a simple verification
                    question generated by our own servers to protect against automated abuse. No
                    third-party security cookies are set, and no device information is collected or
                    shared with third parties such as Google &mdash; we do not use Google reCAPTCHA or
                    similar services governed by{' '}
