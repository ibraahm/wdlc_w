...
import type { NetworkCountry } from '@/lib/api';
...
const BLANK: Partial<NetworkCountry> = { name: '', payoutTypes: ['Cash Collection'], flagUrl: '', active: true };
...
export default function NetworkManager({ countries }: { countries: NetworkCountry[] }) {
  ...
  function openEdit(c: NetworkCountry) { setForm({ ...c }); setEditId(c.id); setError(''); }
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200 text-left text-gray-500">
              ...
              <th className="px-4 py-3 font-medium">Payout types</th>
