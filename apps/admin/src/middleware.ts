...
const PROTECTED_PREFIXES = ['/dashboard', '/settings', '/users', '/partners', '/network', '/agents', '/applications', '/audit', '/news', '/submissions', '/navigation', '/agent-dd', '/branches', '/tellers', '/change-password'];
