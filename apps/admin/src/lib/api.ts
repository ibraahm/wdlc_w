import { API, authFetch, handleResponse } from './api-client';
import type { HumanVerification } from './api-client';
export type { HumanVerification };

// Domain-split modules — re-exported so existing `@/lib/api` imports keep working.
